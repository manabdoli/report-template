...
For the purpose of answering our question, we consider `Shelf` as response and `Manufacturer` as explanatory. The parameters that we will use to answer the question would be the proportion of response levels (shelf locations) given the explanatory levels (manufacturers).
