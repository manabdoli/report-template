...
The goal of this document is to show what you may need to generate a document using an R Markdown, a file with Rmd extension. For more details on using R Markdown see <http://rmarkdown.rstudio.com>.
